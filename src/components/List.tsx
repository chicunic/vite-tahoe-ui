...
export interface SidebarItemProps
  extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof sidebarItemVariants> {
...
export function SidebarSection({ title, children }: { title: string; children: React.ReactNode }): React.ReactElement {
  return (
    <div className="mb-4">
      <Typography variant="caption-1" className="mb-1 px-3 font-bold tracking-tight text-gray-500 uppercase">
        {title}
      </Typography>
