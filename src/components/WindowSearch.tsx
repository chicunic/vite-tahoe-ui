...
export interface WindowSearchProps
  extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size'>, VariantProps<typeof windowSearchVariants> {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        disabled={disabled}
        className={cn(
          'relative z-10 min-w-0 flex-1 bg-transparent text-[13px] leading-4 font-medium outline-none',
