...
export const TextField = React.forwardRef<HTMLInputElement, TextFieldProps>(function TextField(
  ...
  return (
    <div className="flex w-full flex-col gap-1">
      {label && (
        <label htmlFor={inputId} className="px-1 text-[11px] font-medium text-gray-500">
          {label}
        </label>
      )}
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            'border-gray-border dark:bg-dark-bg-200 border bg-white dark:border-none',
...
export const Switch = React.forwardRef<HTMLInputElement, SwitchProps>(function Switch(
  ...
  return (
    <label className={cn('relative inline-flex cursor-pointer items-center', className)}>
      ...
      <div
        className={cn(
          'bg-gray-bg-500 dark:bg-dark-bg-200 h-5.5 w-9.5 rounded-full transition-colors',
  ...
  return (
    <label className="flex cursor-pointer items-center gap-2 select-none">
      <input
        ...
        ref={ref}
        className={cn(
          'border-gray-border h-4 w-4 appearance-none rounded border transition-all dark:border-white/20',
          'bg-white dark:bg-white/5',
          'checked:bg-apple-blue checked:border-transparent',
          'relative after:hidden after:content-[""] checked:after:block',
          'after:absolute after:top-0.5 after:left-1.25 after:h-2 after:w-1 after:rotate-45 after:border-r-2 after:border-b-2 after:border-white',
          'focus-ring',
          className,
        )}
        {...props}
  ...
  return (
    <label className="flex cursor-pointer items-center gap-2 select-none">
      <input
        ...
        ref={ref}
        className={cn(
          'border-gray-border h-4 w-4 appearance-none rounded-full border transition-all dark:border-white/20',
          'bg-white dark:bg-white/5',
          'checked:border-apple-blue checked:border-[5px] checked:bg-white',
          'focus-ring',
          className,
        )}
        {...props}
