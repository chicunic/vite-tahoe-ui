...
export const TextField = React.forwardRef<HTMLInputElement, TextFieldProps>(
  ({ className, label, error, icon, variant = "default", id, ...props }, ref) => {
      ...
      <div className="flex w-full flex-col gap-1">
        ...
        <div className="group relative">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              "h-6 w-full px-2 text-[13px] outline-none transition-all",
              "border border-gray-border bg-white dark:border-none dark:bg-dark-bg-200",
              "focus:border-blue-500/50 focus:ring-[3px] focus:ring-blue-500/30",
