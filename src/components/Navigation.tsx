...
const SegmentSeparator: React.FC<{ visible: boolean }> = ({ visible }) => (
  <div
    className={cn(
...
const SegmentedControl = React.forwardRef<HTMLDivElement, SegmentedControlProps>(
  ({ children, value: controlledValue, defaultValue, onValueChange, className, glass = false }, ref) => {
...
const DisclosureButton = React.forwardRef<HTMLButtonElement, DisclosureButtonProps>(
  ({ expanded = false, onExpandedChange, className, children, ...props }, ref) => {
    return (
      <button
        ref={ref}
        type="button"
